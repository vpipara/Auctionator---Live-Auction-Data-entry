...
error = tk.Label(main_win, text="Ek password tak yaad nhi rehta, kya hoga tumhaara!!! vaapis daal ab!!!", fg="red")
...
err_msg = tk.Label(main_win, text="Naam dhyaan se daal andhe, aisa koi nhi hai jo tune daala!!!", fg="red")
...
latest_update1 = tk.Label(main_win, text="Vaibhav is the hottest guy")
latest_update2 = tk.Label(main_win, text="Vaibhav is the hottest guy")
final_res = tk.Label(main_win, text = "S")
